...
Planned Additions or fixes: 
    ...
    *Add a size command, so it displays the size of the file in bytes, and Megabytes. It should also display the estimated time of file transfer (Downloading).
        Make a similar command for local as well. So the user can predict how long it will take to send or download a particular file.
            To make this work do the noop command and check how long it takes for python to run it. (This may not work test it.)
